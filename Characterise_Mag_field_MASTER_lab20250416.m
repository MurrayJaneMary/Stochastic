...
for Model = 1: Nmodels
    ...
    ResultsTable.t_trans = sum(d_colat >= 45 & d_colat <= 135) / numel(d_colat); 
...
Results = table(ResultsTable.Model, ResultsTable.ModelDuration, ...
    ...
    ResultsTable.Model_G_A, ...
    'VariableNames', ["Model", "Duration (kyr)", "ADF_median", "ADF_iqr", ...
    "NADF_median", "NADF_iqr", "ADF_StableTime", ...
    "NADF_StableTime", "Model_G_A"]);